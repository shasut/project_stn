...
def stn_color_svhn(train_epoch=15, use_stn=True, use_coord_conv=False, verbose=False, flag=None):
    import torch
    ...
    from MyNetworks import STNetBaseColorSVHN, STNetBaseCoordConvColorSVHN
